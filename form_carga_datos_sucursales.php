...
<body id="main_body">
  <div class="container">
	...
	<div class="panel-heading ">
		<h2>Sucursales</h2>
		<p class="small"><?= $_GET['empresa']; ?></p>
		<p>Carga y modificación de sucursales.</p>
	</div>
	<div class="panel-body">
	<form id="form_pacientes" class="input-sm" method="post" action="carga_datos_sucursales.php">
	<input name="req_code" type="hidden" value="<?= $_GET['req_code']; ?>" />
	<input name="id" type="hidden" value="<?= $_GET['id']; ?>" />
	
	<div class="form-group">
		<label for="element2">Denominacion</label>
		<input id="element_2" name="denominacion" class="form-control" type="text" maxlength="30" value="<?= $row['denominacion']; ?>" placeholder="Denominacion sucursal" required/>
	</div>
